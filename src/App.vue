<template>
  <div class="container">
    ...
    <p class="author">
      Made by
      <a href="https://andyalu.github.io/portfolio" target="_blank">andyalu</a>
    </p>
      ...
      <div class="actions-wrapper">
        ...
        <div class="btn-group">
          <button class="btn mark" @click="markAll()">
            <img src="@/assets/checked-mark.png" alt="add" class="btn-icon" />
            ALL
          </button>
    ...
    <div class="task-list">
      ...
      >
        <div class="task-card-content">
          ...
          <p class="task-text" :class="{ 'line-through': task.isCompleted }">
            {{ task.text }}
          </p>
        </div>
